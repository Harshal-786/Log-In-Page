...
class InfoProcessor:
    """Class to process and perform operations with the gathered data."""
    @staticmethod
    def process_info(params):
        """Perform actions with the gathered info."""
        # Example: just return the formatted info as a string (this can be modified as needed)
        return (f"Spinbox Value: {params.spinbox_value}, "
                f"First Text: {params.first_text}, "
                f"Second Text: {params.second_text}, "
                f"Third Text: {params.third_text}, "
                f"Selected Camera: {params.selected_cam}")
...
class Ui_MainWindow(object):
    ...
    def save_values(self):
        ...
        # Process the gathered info with InfoProcessor class
        info = InfoProcessor.process_info(self.params)
